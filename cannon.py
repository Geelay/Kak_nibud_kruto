...
class Gun:
    ...
    def gun_line(self):
        ...
        self.line3 = canv.create_line(self.x + 1.2 * self.size, self.y + 0.9 * self.size, self.x + 1.2 *
                                      self.size + 0.05 * self.size * charge, self.y + 0.9 * self.size, fill='#122FAA',
                                      width=0.1 * self.size)
    ...
    def gun_shell(self):
        ...
        if self.number == 0:
            canv.create_oval(self.x + self.size/4, self.y + self.size/4, self.x + 3 * self.size/4, self.y + 3 *
                             self.size/4, fill=GROUND_COLOR, outline='#543964')
        elif self.number == 1:
            canv.create_oval(self.x + self.size/4, self.y + self.size/4, self.x + 3 * self.size/4, self.y + 3 *
                             self.size/4, fill='#E28B00', outline='#543964')
        elif self.number == 2:
            canv.create_oval(self.x + self.size/4, self.y + self.size/4, self.x + 3 * self.size/4, self.y + 3 *
                             self.size/4, fill='#75151E', outline='#543964')
        elif self.number == 3:
            canv.create_oval(self.x + self.size/4, self.y + self.size/4, self.x + 3 * self.size/4, self.y + 3 *
                             self.size/4, fill='#191970', outline='#543964')
